...
specific version of the Cloud Bigtable V2 API. Most users should consider using
the main client gem,
...
```
$ gem install google-cloud-bigtable-v2
```
...
is part of the name, e.g. `google-cloud-bigtable-v2`.
