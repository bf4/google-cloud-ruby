# -*- encoding: utf-8 -*-
# stub: google-cloud-bigtable-admin-v2 0.16.1 ruby lib

Gem::Specification.new do |s|
  s.name = "google-cloud-bigtable-admin-v2".freeze
  s.version = "0.16.1"
  ...
  s.date = "2023-06-06"
  s.description = "Cloud Bigtable is a fully managed, scalable NoSQL database service for large analytical and operational workloads. Note that google-cloud-bigtable-admin-v2 is a version-specific client library. For most uses, we recommend installing the main client library google-cloud-bigtable instead. See the readme for more details.".freeze
  s.email = "googleapis-packages@google.com".freeze
  s.homepage = "https://github.com/googleapis/google-cloud-ruby".freeze
  s.licenses = ["Apache-2.0".freeze]
  s.required_ruby_version = Gem::Requirement.new(">= 2.6".freeze)
  s.rubygems_version = "3.3.15".freeze
  s.summary = "Administer your Cloud Bigtable tables and instances.".freeze
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<grpc-google-iam-v1>.freeze, ["~> 1.1"])
    ...
    s.add_dependency(%q<grpc-google-iam-v1>.freeze, ["~> 1.1"])
