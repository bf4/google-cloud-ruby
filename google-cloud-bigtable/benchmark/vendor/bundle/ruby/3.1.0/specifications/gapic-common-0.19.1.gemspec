# -*- encoding: utf-8 -*-
# stub: gapic-common 0.19.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_dependency(%q<googleapis-common-protos>.freeze, [">= 1.3.12", "< 2.a"])
    s.add_dependency(%q<googleapis-common-protos-types>.freeze, [">= 1.3.1", "< 2.a"])
